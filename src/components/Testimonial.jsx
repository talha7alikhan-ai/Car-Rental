...
// Added testimonials array declaration correctly
const testimonials = [
  {   
    name: "Emma Rodriguez", 
  ...
  {  
    ...
    image: assets.testimonial_image_1,  
    testimonial: "I highly recommend CarRental! thier fleet is amazing and i always feel like i'm getting the best deal with excellent service."
  }
];

// Minimal Star component placeholder, since you use it in code
const Star = ({ filled }) => (
  <span>{filled ? '★' : '☆'}</span>
);
    ...
    className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-18">
        {testimonials.map((testimonial, index) => (
          <motion.div initial={{opacity:0, y:40}} whileInView={{opacity:1, y:0}} transition={{duration:0.6, delay:index * 0.2, ease:'easeInOut'}} viewport={{ once: true, amount: 0.3 }}
