    ...
    return (
        <div className='px-4 pt-10 md:px-10 flex-1'>
            ...
            <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
                {/* recent booking */}
                <div className='p-4 md:p-6 border border-borderColor rounded-md max-w-xl w-full'>
                        ...
                        {data.recentBookings.map((booking, index) => (
                            <div key={index} className='flex items-center justify-between'>
                                ...
                                <div className='flex items-center gap-3'>
                                    ...
                                    <div>
                                        <p className='text-sm font-semibold'>{booking.car.brand} {booking.car.model}</p>
                                ...
                                <div className='flex items-center gap-4 font-medium'>
                                    <p className='text-xs text-gray-500'>{currency}{booking.price}</p>
                                    <p className={`px-4 py-1 border border-borderColor rounded-full text-[11px] font-semibold
                                        ${booking.status === 'confirmed' ? 'bg-gray-50' : 'bg-gray-100/50'}`}>
                                        {booking.status}
                                    </p>
                                </div>
                            </div>
